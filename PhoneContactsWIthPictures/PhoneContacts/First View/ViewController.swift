...
//    let phoneTypes = ["Cell", "Work", "Home"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        displayViewController.receivedContact = selectedContact
        displayViewController.mainDelegate = self
...
extension ViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let uwContactPicture = contacts[indexPath.row].image {
            cell.imageReceipt.image  = uwContactPicture
        }
